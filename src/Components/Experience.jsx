  ...
  return (
    <section id="experience" className="bg-transparent py-24 text-center">
      <motion.h1
        ...
        className="text-2xl sm:text-4xl font-semibold text-white mb-16"
      >
      ...
      <div className="max-w-4xl mx-auto space-y-14 px-6">
        {EXPERIENCES.map((exp, idx) => (
          ...
          >
            ...
            <p className="text-xs sm:text-sm text-purple-500 mb-4">{exp.year}</p>
            <p className="text-sm sm:text-base text-neutral-300 mb-4">{exp.description}</p>
            ...
            {exp.details && (
              <div>
                ...
                {expandedIndex === idx && (
                  <ul className="mt-4 list-disc list-inside space-y-2 text-neutral-400 bg-neutral-900/30 p-4 rounded-md text-sm sm:text-base">
